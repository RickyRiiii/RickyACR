...
public class Style
{
    ...
    //保存style设置的地方
    public static RPRSettings Settings => RPRSettings.Instance; //改成自己的设置文件
    ...
    public class QtWindowClass
    {
        ...
        public void DrawQtWindow()
        {
            ...
            foreach (var qtName in QtNameList)
            {
                ...
                var qt = QtDict[qtName];
                if (SwitchButton(qtName, ref qt.QtValue))
    ...
    public static void ChangeStyleView()
    {
        ...
        if (ImGui.SliderFloat("Qt背景透明度", ref qtBackGroundAlpha, 0f, 1f, "%.1f"))
        {
    ...
    public static bool SwitchButton(string label, ref bool buttonValue)
    {
    ...
    public static int MainControlView(ref bool buttonValue, ref bool stopButton)
    {
        ...
        //保存按钮
        ImGui.SameLine(0, 25);
        ImGui.BeginChild("##保存设置", new Vector2(-1, 50));
